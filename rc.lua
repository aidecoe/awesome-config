...
mytextclock = awful.widget.textclock({ align = "right" }, " %m/%d (%j)  %H:%M:%S ", 1)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey            }, "y", function () awful.layout.set(awful.layout.suit.tile.bottom) end),
    awful.key({ modkey            }, "a", function () awful.layout.set(awful.layout.suit.fair.horizontal) end),
...
-- {{{ Misc
awful.wibox({ position = "bottom", screen = 1, ontop = false, width = 1, height = 22 })
-- }}}
